...
var ValueRepresentation = /** @class */ (function () {
    ...
    ValueRepresentation.prototype.write = function (stream, type) {
        ...
        var func = stream["write" + type];
        var firstValue = valueArgs[0];
    ...
    ValueRepresentation.prototype.writeByteLengths = function (stream, value, lengths, isEncapsulated) {
        ...
        for (var i = 0; i < valarr.length; i++) {
            ...
            var errmsg = "Value exceeds max length, vr: " +
                this.type +
                ", value: " +
                checkValue +
                ", length: " +
    ...
    BinaryRepresentation.prototype.writeBytes = function (stream, value, syntax, isEncapsulated) {
        ...
        if (isEncapsulated) {
            ...
            for (i = 0; i < frames; i++) {
                ...
                var fragmentsLength_1 = 1;
                if (fragmentMultiframe) {
                    fragmentsLength_1 = Math.ceil(value[i].byteLength / fragmentSize);
                }
                // 8 bytes per fragment are needed to store 0xffff (2 bytes), 0xe000 (2 bytes), and frageStream size (4 bytes)
                bufferLength += fragmentsLength_1 * 8;
            }
            var binaryStream = new WriteBufferStream(bufferLength, stream.isLittleEndian);
            ...
            for (var i = 0; i < frames; i++) {
                ...
                for (var j = 0, fragmentStart = 0; j < fragmentsLength; j++) {
                    ...
                    var addPaddingByte = isFinalFragment && needsPadding;
...
var AttributeTag = /** @class */ (function (_super) {
    ...
    AttributeTag.prototype.writeBytes = function (stream, value) {
        return this.writeByteLengths(stream, value, _super.prototype.write.call(this, stream, "Uint32", value));
    };
    return AttributeTag;
}(ValueRepresentation));
export { AttributeTag };
var DateValue = /** @class */ (function (_super) {
    ...
    function DateValue() {
        var _this = _super.call(this, "DA") || this;
        _this.maxLength = 18;
        _this.padByte = "20";
        _this.defaultValue = "";
        return _this;
...
var FloatingPointSingle = /** @class */ (function (_super) {
    ...
    FloatingPointSingle.prototype.writeBytes = function (stream, value) {
        return this.writeByteLengths(stream, value, _super.prototype.write.call(this, stream, "Float", value));
    };
...
var FloatingPointDouble = /** @class */ (function (_super) {
    ...
    FloatingPointDouble.prototype.writeBytes = function (stream, value) {
        return this.writeByteLengths(stream, value, _super.prototype.write.call(this, stream, "Double", value));
    };
...
var SignedLong = /** @class */ (function (_super) {
    ...
    SignedLong.prototype.writeBytes = function (stream, value) {
        return this.writeByteLengths(stream, value, _super.prototype.write.call(this, stream, "Int32", value));
    };
    return SignedLong;
}(ValueRepresentation));
export { SignedLong };
...
var SignedShort = /** @class */ (function (_super) {
    ...
    SignedShort.prototype.writeBytes = function (stream, value) {
        return this.writeByteLengths(stream, value, _super.prototype.write.call(this, stream, "Int16", value));
    };
    return SignedShort;
}(ValueRepresentation));
export { SignedShort };
...
var UnsignedShort = /** @class */ (function (_super) {
    ...
    UnsignedShort.prototype.writeBytes = function (stream, value) {
        return this.writeByteLengths(stream, value, _super.prototype.write.call(this, stream, "Uint16", value));
    };
